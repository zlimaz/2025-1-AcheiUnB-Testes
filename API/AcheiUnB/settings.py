...
EMAIL_HOST_USER = os.getenv("EMAIL_HOST_USER", "acheiunb2024@gmail.com")
EMAIL_HOST_PASSWORD = os.getenv("EMAIL_HOST_PASSWORD") #é preciso colocar a senha de app diretamente para funcionar
