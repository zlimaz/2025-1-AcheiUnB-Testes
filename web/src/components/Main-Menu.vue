<template>
  <div class="h-full bg-azul shadow-md rounded-t-xl flex items-center justify-center text-white gap-x-9 p-8">
    ...
    <router-link to="/user" class="no-underline">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
        class="size-6 hover:text-laranja hover:cursor-pointer" :class="{ 'text-laranja': activeIcon == 'user' }">
        <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <router-link to="/about" class="no-underline">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
        class="size-6 hover:text-laranja hover:cursor-pointer" :class="{ 'text-laranja': activeIcon == 'info' }">
        <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <router-link to="/chats" class="no-underline">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
        class="size-6 hover:text-laranja hover:cursor-pointer" :class="{ 'text-laranja': activeIcon == 'chat' }">
        <path stroke-linecap="round" stroke-linejoin="round"
