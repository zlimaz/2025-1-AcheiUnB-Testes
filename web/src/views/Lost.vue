<template>
    <div class="min-h-screen bg-azulclaro">
        ...
        <div class="flex w-full justify-start sm:justify-center gap-x-6 pb-[120px] px-10">
            <img src="../assets/icons/arrow-left.svg" alt="" class="w-[30px] h-[30px]" />
            <img src="../assets/icons/arrow-right.svg" alt="" class="w-[30px] h-[30px]" />
        </div>
