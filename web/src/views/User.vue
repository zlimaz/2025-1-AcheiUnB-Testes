<template>
  <div class="flex flex-col items-center px-6 pt-10 lg:pt-16">
    ...
    <div class="w-24 h-24 lg:w-32 lg:h-32 rounded-full flex items-center justify-center border-4 border-laranja overflow-hidden">
      ...
      />
      <div v-else class="w-full h-full bg-cinza2 flex items-center justify-center text-cinza3 text-sm lg:text-lg">
        Foto Padrão
      </div>
    </div>
    ...
    <div class="pt-[30px] lg:pt-[50px] flex flex-col items-center w-full mt-6 space-y-4 lg:space-y-6">
      <router-link to="/user-items-lost" class="w-full flex justify-center">
        <button class="bg-verde text-white w-full md:w-[70%] lg:w-[40%] font-medium py-4 rounded-full hover:scale-110 transition-transform duration-300 text-center text-lg lg:text-xl">
          Meus itens ativos
        </button>
      </router-link>
